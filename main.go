...
func main() {
	var (
		...
		allowNull = flag.Bool("allownull", true, "Allows null values in the JSON schema, these values will be interface{}")
	)
	...
	structs := structbuilder.GenerateStructs(jsonObject, *useKeyNames, *allowNull)
